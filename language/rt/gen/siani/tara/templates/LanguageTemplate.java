...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("type", "word")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", new String[]{")).add(mark("words", "quoted").multiple(", ")).add(literal("}, ")).add(mark("multiple")).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("contract")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", new String[]{")).add(mark("types", "quoted").multiple(", ")).add(literal("}, ")).add(mark("multiple")).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("contract")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", \"")).add(mark("type")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("contract")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "allow")), (condition("type", "facet")), (condition("trigger", "allow"))).add(literal("facet(\"")).add(mark("value")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("with", "quoted").multiple(", "))).add(literal(")")).add(expression().add(literal(".require(")).add(mark("require").multiple(", ")).add(literal(")"))).add(expression().add(literal(".allow(")).add(mark("allow").multiple(", ")).add(literal(")"))),
			...
			rule().add((condition("type", "require")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", new String[]{")).add(mark("types", "quoted").multiple(", ")).add(literal("}, ")).add(mark("multiple")).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("contract")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "require")), (condition("type", "parameter")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", \"")).add(mark("type")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("contract")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
