...
public class ConstructorTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable")), (condition("type", "native")), (condition("type", "owner")), not(condition("type", "inherited")), (condition("trigger", "constructor"))).add(literal("_load(\"")).add(mark("name", "firstLowerCase")).add(literal("\", ")).add(mark("generatedLanguage")).add(literal(".natives.")).add(mark("package")).add(literal(".")).add(mark("name", "javaValidName")).add(literal("_")).add(mark("uid")).add(literal(".class.getName());")),
			rule().add((condition("type", "Variable")), (condition("type", "owner")), not(condition("type", "inherited")), (condition("type", "function")), (condition("Slot", "body")), (condition("trigger", "constructor"))).add(literal("_load(\"")).add(mark("name", "firstLowerCase")).add(literal("\", ")).add(mark("generatedLanguage")).add(literal(".natives.")).add(mark("package")).add(literal(".")).add(mark("name", "javaValidName")).add(literal("_")).add(mark("uid")).add(literal(".class.getName());")),
			...
			rule().add((condition("type", "Variable")), (condition("type", "owner")), (condition("type", "reference")), not(condition("type", "inherited")), (condition("Slot", "values")), (condition("type", "multiple")), (condition("trigger", "constructor"))).add(literal("_load(\"")).add(mark("name", "firstLowerCase")).add(literal("\", new java.util.ArrayList<>(java.util.Arrays.asList(_model().definitionOf(\"")).add(mark("type")).add(literal("\"))));")),
