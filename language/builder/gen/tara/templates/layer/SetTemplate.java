...
public class SetTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "facetTarget")), (condition("type", "overriden")), (condition("trigger", "set"))).add(literal("_")).add(mark("name", "firstLowerCase")).add(literal(".instance().set(_")).add(mark("name", "firstLowerCase")).add(literal(", name, values);")),
