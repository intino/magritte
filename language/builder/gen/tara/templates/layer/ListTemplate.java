...
public class ListTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable & reference & owner")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "list"))).add(literal("map.put(\"")).add(mark("name", "firstLowerCase")).add(literal("\", this.")).add(mark("name")).add(literal(" != null ? new java.util.ArrayList(java.util.Collections.singletonList(")).add(mark("name", "firstLowerCase")).add(literal(")) : null);")),
			rule().add((condition("type", "Variable & function & owner")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "list"))).add(literal("map.put(\"")).add(mark("name", "firstLowerCase")).add(literal("\", this.")).add(mark("name")).add(literal(" != null ? new java.util.ArrayList(java.util.Collections.singletonList(")).add(mark("name", "firstLowerCase")).add(literal(")) : null);")),
			...
			rule().add((condition("type", "Variable & target & multiple")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "list"))).add(literal("map.put(\"")).add(mark("name", "firstLowerCase")).add(literal("\", _")).add(mark("container", "firstLowerCase")).add(literal(".")).add(mark("name", "firstLowerCase")).add(literal("());")),
			rule().add((condition("type", "Variable & target")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "list"))).add(literal("map.put(\"")).add(mark("name", "firstLowerCase")).add(literal("\", new java.util.ArrayList(java.util.Collections.singletonList(_")).add(mark("container", "firstLowerCase")).add(literal(".")).add(mark("name", "firstLowerCase")).add(literal("())));")),
