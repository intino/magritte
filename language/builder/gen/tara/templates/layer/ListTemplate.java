...
public class ListTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Node & single & owner")), not(condition("type", "inherited")), not(condition("type", "overriden")), not(condition("type", "overriden")), (condition("trigger", "list"))).add(literal("if (")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" != null) nodes.add(")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(".node());")),
			rule().add((condition("type", "Node")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("type", "owner")), (condition("trigger", "list"))).add(mark("name", "firstLowerCase")).add(literal("List.stream().forEach(c -> nodes.add(c.node()));")),
			rule().add((condition("type", "Node & single & feature & owner")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "featureList"))).add(literal("if (")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" != null) features.add(")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(".node());")),
			rule().add((condition("type", "Node & feature & owner")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "featureList"))).add(mark("name", "firstLowerCase")).add(literal("List.stream().forEach(c -> features.add(c.node()));")),
			rule().add((condition("type", "Node & single & owner")), not(condition("type", "feature")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "componentList"))).add(literal("if (")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" != null) components.add(")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(".node());")),
			rule().add((condition("type", "Node & owner")), not(condition("type", "feature")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "componentList"))).add(mark("name", "firstLowerCase")).add(literal("List.stream().forEach(c -> components.add(c.node()));")),
