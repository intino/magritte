...
public class SettersTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable & file")), not(condition("type", "target")), not(condition("type", "inherited")), not(condition("type", "overriden")), not(condition("type", "multiple")), not(condition("type", "final")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "firstLowerCase")).add(literal("(java.net.Url url, String destiny) {\n\tthis.")).add(mark("name", "firstLowerCase")).add(literal(" = _model().save(url, destiny);\n}\n\npublic void ")).add(mark("name", "firstLowerCase")).add(literal("(java.io.ImputStream stream, String destiny) {\n\tthis.")).add(mark("name", "firstLowerCase")).add(literal(" = _model().save(stream, destiny);\n}")),
