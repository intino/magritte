...
public class SettersTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "Variable & Word")), not(condition("type", "multiple")), not(condition("type", "owner")), not(condition("type", "reactive")), not(condition("type", "final")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "javaValidWord")).add(literal("(")).add(mark("qn", "reference")).add(literal(".")).add(mark("name", "javaValidWord", "reference")).add(literal(" value) {\n\tthis._")).add(mark("containerName", "firstLowerCase")).add(literal(".")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(value);\n}")),
			rule().add((condition("type", "Variable & resource")), not(condition("type", "multiple")), not(condition("type", "owner")), not(condition("type", "reactive")), not(condition("type", "final")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(")).add(mark("type", "variableType")).add(literal(" value, String destiny) {\n\tthis._")).add(mark("containerName", "firstLowerCase")).add(literal(".")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(value, destiny);\n}")),
			rule().add((condition("type", "Variable")), not(condition("type", "multiple")), not(condition("type", "owner")), not(condition("type", "Concept")), not(condition("type", "function")), not(condition("type", "resource")), not(condition("type", "reactive")), not(condition("type", "final")), not(condition("type", "Word")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(")).add(mark("type", "variableType")).add(literal(" value) {\n\tthis._")).add(mark("containerName", "firstLowerCase")).add(literal(".")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(value);\n}")),
			...
			rule().add((condition("type", "Variable & resource")), not(condition("type", "target")), not(condition("type", "inherited")), not(condition("type", "overriden")), not(condition("type", "reactive")), not(condition("type", "multiple")), not(condition("type", "final")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(java.net.URL url, String destiny) {\n\tthis.")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" = model().save(url, destiny, this.")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(", instance());\n}\n\npublic void ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(java.io.InputStream stream, String destiny) {\n\tthis.")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" = model().save(stream, destiny, this.")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(", instance());\n}")),
			rule().add((condition("type", "Variable")), not(condition("type", "inherited")), not(condition("type", "concept")), not(condition("type", "overriden")), not(condition("type", "function")), not(condition("type", "reactive")), not(condition("type", "multiple")), not(condition("type", "final")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(")).add(mark("type", "variableType")).add(literal(" value) {\n\tthis.")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" = value;\n}")),
			rule().add((condition("type", "variable & reference & concept & multiple & owner")), not(condition("type", "final")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "setter"))).add(literal("public void ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal("(java.util.List<tara.magritte.Concept> value) {\n\tthis.")).add(mark("name", "javaValidWord", "firtLowercase")).add(literal(" = value;\n}")),
