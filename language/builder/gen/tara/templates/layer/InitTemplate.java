...
public class InitTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "facetTarget")), (condition("type", "overriden")), (condition("trigger", "init"))).add(literal("_")).add(mark("name", "firstLowerCase")).add(literal(".instance().load(_")).add(mark("name", "firstLowerCase")).add(literal(", name, objects);")),
