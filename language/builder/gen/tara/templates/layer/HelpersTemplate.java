...
public class HelpersTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("value", "file")), (condition("trigger", "variableType"))).add(literal("java.net.URL")),
			...
			rule().add((condition("value", "file")), (condition("trigger", "variableTypeList"))).add(literal("java.net.URL")),
