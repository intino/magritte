...
public class DeclarationTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable & owner & concept")), (condition("type", "multiple")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "declaration"))).add(literal("protected java.util.List<tara.magritte.Concept> ")).add(mark("name", "javaValidWord", "firstLowerCase")).add(literal(" = new java.util.ArrayList<>();")),
			...
			rule().add((condition("type", "Node & owner")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("type", "single")), (condition("trigger", "declaration"))).add(literal("protected ")).add(mark("qn", "reference")).add(literal(" ")).add(mark("name", "javaValidWord", "firstLowerCase")).add(literal(";")),
