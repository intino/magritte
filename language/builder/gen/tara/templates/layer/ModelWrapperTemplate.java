...
public class ModelWrapperTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "node & single")), (condition("trigger", "assign"))).add(mark("name", "firstLowerCase")).add(literal(" = _model.components(")).add(mark("qn", "reference")).add(literal(".class).stream().findFirst().orElse(null);")),
			rule().add((condition("type", "node")), (condition("trigger", "assign"))).add(mark("name", "firstLowerCase")).add(literal("List = _model.components(")).add(mark("qn", "reference")).add(literal(".class);")),
