...
public class ModelHandlerTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "node & concept")), not(condition("type", "final")), (condition("trigger", "new"))).add(literal("public ")).add(mark("qn", "reference")).add(literal(" new")).add(mark("name", "firstUpperCase")).add(literal("(String spacename, String name")).add(expression().add(literal(", ")).add(mark("variable", "parameters").multiple(", "))).add(literal(") {\n\t")).add(mark("qn", "reference")).add(literal(" newElement = model.newMain(")).add(mark("qn", "reference")).add(literal(".class, spacename, name).as(")).add(mark("qn", "reference")).add(literal(".class);\n    ")).add(expression().add(literal("newElement.")).add(mark("variable", "assign").multiple("\n\tnewElement."))).add(literal("\n\treturn newElement;\n\n}\npublic ")).add(mark("qn", "reference")).add(literal(" new")).add(mark("name", "firstUpperCase")).add(literal("(String spacename")).add(expression().add(literal(", ")).add(mark("variable", "parameters").multiple(", "))).add(literal(") {\n    ")).add(mark("qn", "reference")).add(literal(" newElement = model.newMain(")).add(mark("qn", "reference")).add(literal(".class, spacename).as(")).add(mark("qn", "reference")).add(literal(".class);\n    ")).add(expression().add(literal("newElement.")).add(mark("variable", "assign").multiple("\n\tnewElement."))).add(literal("\n    return newElement;\n}"))
		);
		return this;
	}
}