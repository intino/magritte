...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "constraint")), (condition("type", "component")), (condition("trigger", "constraint"))).add(literal("component(")).add(mark("type", "quoted")).add(literal(", ")).add(mark("size")).add(expression().add(literal(", ")).add(mark("tags").multiple(", "))).add(literal(")")),
			...
			rule().add((condition("type", "constraint")), (condition("type", "facet")), (condition("trigger", "constraint"))).add(literal("facet(\"")).add(mark("value")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("terminal"))).add(expression().add(literal(", ")).add(mark("with", "quoted").multiple(", "))).add(literal(")")).add(expression().add(literal(".has(")).add(mark("constraint").multiple(", ")).add(literal(")"))),
			...
			rule().add((condition("type", "nativerule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.NativeRule(")).add(mark("interfaceClass", "quoted")).add(literal(", ")).add(mark("signature", "quoted")).add(literal(", ")).add(mark("language", "quoted")).add(literal(")")),
			rule().add((condition("type", "wordrule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal(")")).add(expression().add(literal(", ")).add(mark("externalWordClass", "quoted"))).add(literal(", ")).add(mark("size")).add(literal(")")),
			rule().add((condition("type", "referenceRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.ReferenceRule(java.util.Arrays.asList(")).add(mark("constraintedReferences", "quoted").multiple(", ")).add(literal("))")),
			...
			rule().add((condition("type", "fileRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.FileRule(Arrays.asList(")).add(mark("extensions", "quoted").multiple(", ")).add(literal("))")),
