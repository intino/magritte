...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "constraint")), (condition("type", "facet")), (condition("trigger", "constraint"))).add(literal("facet(\"")).add(mark("value")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("terminal")).or(expression().add(literal(", false")))).add(expression().add(literal(", ")).add(mark("with", "quoted").multiple(", "))).add(literal(")")).add(expression().add(literal(".has(")).add(mark("constraint").multiple(", ")).add(literal(")"))),
