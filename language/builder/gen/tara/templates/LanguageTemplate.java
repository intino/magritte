...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "rule & native")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.NativeRule(")).add(mark("interfaceClass", "quoted")).add(literal(", ")).add(mark("signature", "quoted")).add(literal(", ")).add(mark("language", "quoted")).add(literal(")")),
			rule().add((condition("type", "rule & word")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal("), ")).add(mark("custom")).add(literal(")")),
			rule().add((condition("type", "rule & reference")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.ReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "rule & double")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DoubleRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "rule & integer")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.IntegerRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "rule & date")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DateRule(")).add(mark("parameters", "quoted")).add(literal(")")),
			rule().add((condition("type", "rule & file")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.FileRule(")).add(mark("extensions", "quoted").multiple(", ")).add(literal(")")),
			rule().add((condition("type", "rule & string")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.StringRule(")).add(mark("regex", "quoted")).add(literal(")")),
