...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "constraint")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "constraint"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", \"")).add(mark("type")).add(literal("\", ")).add(mark("size")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("tags").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "constraint")), (condition("type", "parameter")), (condition("trigger", "constraint"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", ")).add(mark("type", "primitive")).add(literal(", ")).add(mark("size")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("tags").multiple(", "))).add(literal(")")),
			...
			rule().add((condition("type", "nativeReferenceRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.NativeReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("), \"")).add(mark("language")).add(literal("\")")),
