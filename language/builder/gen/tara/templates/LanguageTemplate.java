...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "rule & nativerule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.NativeRule(")).add(mark("interfaceClass", "quoted")).add(literal(", ")).add(mark("signature", "quoted")).add(literal(", ")).add(mark("language", "quoted")).add(literal(")")),
			rule().add((condition("type", "rule & wordrule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal("), ")).add(mark("custom")).add(literal(")")),
			rule().add((condition("type", "rule & referenceRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.ReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "rule & doubleRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DoubleRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "rule & integerRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.IntegerRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "rule & dateRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DateRule(")).add(mark("parameters", "quoted")).add(literal(")")),
			rule().add((condition("type", "rule & fileRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.FileRule(")).add(mark("extensions", "quoted").multiple(", ")).add(literal(")")),
			rule().add((condition("type", "rule & stringRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.StringRule(")).add(mark("regex", "quoted")).add(literal(")")),
