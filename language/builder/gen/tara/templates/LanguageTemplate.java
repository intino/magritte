...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "nativeObjectRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.NativeObjectRule(\"")).add(mark("type")).add(literal("\", \"")).add(mark("language")).add(literal("\")")),
