...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")).add(literal("\n")),
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", ")).add(mark("type", "primitive")).add(literal(", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")).add(literal("\n")),
			...
			rule().add((condition("type", "require & parameter & reference")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")).add(literal("\n")),
			rule().add((condition("type", "require")), (condition("type", "parameter")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", ")).add(mark("type", "primitive")).add(literal(", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")).add(literal("\n")),
			...
			rule().add((condition("type", "nativerule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.NativeRule(")).add(mark("interfaceClass", "quoted")).add(literal(", ")).add(mark("signature", "quoted")).add(literal(", ")).add(mark("language", "quoted")).add(literal(")")),
			rule().add((condition("type", "wordrule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal(")")).add(expression().add(literal(", ")).add(mark("externalWordClass", "quoted"))).add(literal(", new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
			rule().add((condition("type", "referenceRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.ReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("), new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
			rule().add((condition("type", "doubleRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DoubleRule(")).add(mark("min", "cast")).add(literal(", ")).add(mark("max", "cast")).add(literal(", \"")).add(mark("metric")).add(literal("\", new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
			rule().add((condition("type", "size")), (condition("type", "rule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.(")).add(mark("min", "cast")).add(literal(", ")).add(mark("max", "cast")).add(literal(", \"")).add(mark("metric")).add(literal("\", new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
			rule().add((condition("type", "integerRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.IntegerRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "dateRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DateRule(")).add(mark("parameters", "quoted")).add(literal(", new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
			rule().add((condition("type", "fileRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.FileRule(Arrays.asList(")).add(mark("extensions", "quoted").multiple(", ")).add(literal("), new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
			rule().add((condition("type", "stringRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.StringRule(")).add(mark("regex", "quoted")).add(literal(", new tara.lang.model.rules.Size(")).add(mark("sizeMin")).add(literal(", ")).add(mark("sizeMax")).add(literal("))")),
