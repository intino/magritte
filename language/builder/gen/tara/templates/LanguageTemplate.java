...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "require")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", ")).add(expression().add(mark("rule")).or(expression().add(literal("null")))).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")).add(literal("\n")),
			...
			rule().add((condition("type", "rule")), (condition("type", "word")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal("), ")).add(mark("custom")).add(literal(")")),
			rule().add((condition("type", "rule & reference")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.ReferenceRule(")).add(mark("allowedReferences").multiple(", ")).add(literal(")")),
