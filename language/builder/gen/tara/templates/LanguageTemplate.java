...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("type", "word")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", new String[]{")).add(mark("words", "quoted").multiple(", ")).add(literal("}, ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("rule")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", new String[]{")).add(mark("types", "quoted").multiple(", ")).add(literal("}, ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("rule")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "allow")), (condition("type", "parameter")), (condition("trigger", "allow"))).add(literal("parameter(\"")).add(mark("name")).add(literal("\", \"")).add(mark("type")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("rule")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			...
			rule().add((condition("type", "require")), (condition("type", "parameter")), (condition("type", "reference")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", new String[]{")).add(mark("types", "quoted").multiple(", ")).add(literal("}, ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("rule")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
			rule().add((condition("type", "require")), (condition("type", "parameter")), (condition("trigger", "require"))).add(literal("_parameter(\"")).add(mark("name")).add(literal("\", \"")).add(mark("type")).add(literal("\", ")).add(mark("multiple")).add(literal(", ")).add(expression().add(literal("\"")).add(mark("default")).add(literal("\"")).or(expression().add(literal("null")))).add(literal(", ")).add(mark("position")).add(literal(", \"")).add(mark("rule")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("annotations", "quoted").multiple(", "))).add(literal(")")),
