...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "wordrule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal(")")).add(expression().add(literal(", ")).add(mark("externalWordClass", "quoted"))).add(literal(")")),
			...
			rule().add((condition("type", "doubleRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.DoubleRule(")).add(mark("min", "cast")).add(literal(", ")).add(mark("max", "cast")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
