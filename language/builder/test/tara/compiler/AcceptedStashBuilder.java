...
public class AcceptedStashBuilder {
	...
	public void should_build_stash_with_many_entries() throws Exception {
		...
		assertThat(stash.cases.get(10).variables.get(0).v, is(1320040860000L));
		assertThat(stash.cases.get(10).variables.get(5).v, is(23.0));
		assertThat(stash.cases.get(1000).variables.get(5).v, is(32.9));
	}
	...
	public void should_build_stash_with_passes() throws Exception {
		...
		assertThat("temperature variable has right value", stash.cases.get(0).variables.get(2).v, is(7.0));
