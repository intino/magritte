...
public class KryoTest {
	...
	public void testName() throws Exception {
		final Stash stash = newStash("tela", emptyList(), emptyList(), emptyList(), singletonList(newInstance("jose", singletonList(newFacet("name", singletonList(newBoolean("var", singletonList(true))), emptyList())))));
