...
annotation: TERMINAL | COMPONENT | FEATURE | PROTOTYPE | ENCLOSED;

flags: IS flag+;
flag: ABSTRACT | TERMINAL | COMPONENT | PRIVATE
      	| FEATURE | PROTOTYPE | ENCLOSED | FINAL | NAMED | CONCEPT | NATIVE | PROFILER;
