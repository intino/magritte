...
public class Creation {
	...
	private Stash mockStash() {
		return newStash("Proteo", list(), list(), list(
				newConcept("Child", false, false, false, true, "io.intino.magritte.framework.layers.Child", "Parent", list("Concept"), list(), list(newString("childVar", list("child"))), list(newString("fillByChildVar", "filledByChild")), list()),
				newConcept("Parent", false, false, false, true, "io.intino.magritte.framework.layers.Parent", "Grandparent", list("Concept"), list(), list(newString("parentVar", list("parent")), newString("fillByChildVar", "toBeFilled")), list(newString("fillByParentVar", "filledByParent")), list()),
				newConcept("Grandparent", false, false, false, true, "io.intino.magritte.framework.layers.Grandparent", null, list("Concept"), list(), list(newString("grandparentVar", list("grandparent")), newString("fillByParentVar", list("toBeFilled"))), list(), list())
		), list());
	}
}
