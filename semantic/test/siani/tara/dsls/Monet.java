...
public class Monet extends Tara {
	public Monet() {
		...
		in("Section").def(context("Concept").allow(multiple("Entity.Toolbar"), multiple("Text", Tag.SINGLE), multiple("Memo", Tag.SINGLE), multiple("Number", Tag.SINGLE), multiple("Check", Tag.SINGLE), multiple("Date", Tag.SINGLE), multiple("Picture", Tag.SINGLE), multiple("Link", Tag.SINGLE), multiple("Serial", Tag.SINGLE), multiple("Select", Tag.SINGLE), multiple("Section", Tag.SINGLE), multiple("Multiple"), parameter("onCreate", "native", false, 0, "OnCreate#"), parameter("onOpen", "native", false, 1, "OnOpen#"), parameter("onClose", "native", false, 2, "OnClose#"), parameter("onSave", "native", false, 3, "OnSave#"), parameter("onChange", "native", false, 4, "OnChange#"), parameter("onRemove", "native", false, 5, "OnRemove#"), name()).require(_multiple("Section.View"), _parameter("validate", "native", false, 6, "FieldValidate#")));
		in("Entity.Toolbar").def(context("Concept").allow(multiple("Entity.Toolbar.Operation"), name()).assume(isFeatureInstance()));
		...
		in("Prototypable").def(context("Concept").allow(name()).assume(isFacetInstance()));
		in("Georeferenced").def(context("Concept").allow(name()).assume(isFacetInstance()));
		in("Exportable").def(context("Concept").allow(name()).assume(isFacetInstance()));
		in("Importable").def(context("Concept").allow(name()).assume(isFacetInstance()));
		in("Restricted").def(context("Concept").allow(name()).assume(isFacetInstance()));
		...
		in("Process").def(context("Concept").allow(multiple("Task.Auditory"), multiple("Task.Suggestion"), name()).require(_multiple("Process.WorkMap"), _single("Process.State"), _single("Process.History")).assume(isFacetInstance()));
		...
		in("Process.State").def(context("Concept").allow(parameter("place", new String[]{"Place"}, false, 0, "", "TERMINAL"), parameter("mission", new String[]{"Mission"}, false, 1, "", "TERMINAL"), name()).assume(isTerminalInstance()));
		in("Process.History").def(context("Concept").allow(multiple("Process.History.Step", Tag.TERMINAL), name()).assume(isTerminalInstance()));
		in("Process.History.Step").def(context("Concept").allow(parameter("executed", "date", false, 0, "", "TERMINAL"), parameter("description", "string", false, 1, "", "TERMINAL"), name()).assume(isTerminal()));
		in("Process.WorkMap").def(context("Concept").allow(multiple("Place"), name()).require(_multiple("Initial"), _multiple("Terminal")).assume(isFeatureInstance()));
		in("Service").def(context("Concept").allow(multiple("Task.Auditory"), multiple("Task.Suggestion"), name()).assume(isFacetInstance()));
		in("Task.Auditory").def(context("Concept").allow(name()).assume(isTerminalInstance()));
		in("Task.Suggestion").def(context("Concept").allow(name()).assume(isTerminalInstance()));
		in("Job").def(context("Concept").allow(multiple("Task.Auditory"), multiple("Task.Suggestion"), name()).assume(isFacetInstance()));
		in("Task.Auditory").def(context("Concept").allow(name()).assume(isTerminalInstance()));
		in("Task.Suggestion").def(context("Concept").allow(name()).assume(isTerminalInstance()));
		...
		in("Terminal").def(context("Concept").allow(name()).assume(isFacetInstance()));
		...
		in("Form").def(context("Concept").allow(multiple("FieldView.Display"), multiple("FieldView.Disable"), name()).assume(isFacetInstance()));
		in("FieldView.Display").def(context("Concept").allow(name()));
		in("FieldView.Disable").def(context("Concept").allow(name()));
		in("Table").def(context("Concept").allow(multiple("FieldView.Display"), multiple("FieldView.Disable"), name()).assume(isFacetInstance()));
		in("FieldView.Display").def(context("Concept").allow(name()));
		in("FieldView.Disable").def(context("Concept").allow(name()));
		in("Poll").def(context("Concept").allow(multiple("FieldView.Display"), multiple("FieldView.Disable"), name()).assume(isFacetInstance()));
		in("FieldView.Display").def(context("Concept").allow(name()));
		in("FieldView.Disable").def(context("Concept").allow(name()));
		in("Collection").def(context("Concept").allow(multiple("Collection.Display"), name(), facet("ReadOnly")).assume(isFacetInstance()));
		...
		in("Folder").def(context("Concept").allow(name()).assume(isFacetInstance()));
