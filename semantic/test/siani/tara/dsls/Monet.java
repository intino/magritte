...
public class Monet extends Tara {
	public Monet() {
		...
		in("Multiple").def(context("Concept").allow(parameter("onChange", "native", false, 1, "OnChange"), parameter("min", "integer", false, 2, ""), parameter("max", "integer", false, 3, ""), name()).require(oneOf(_single("Text", Tag.MULTIPLE), _single("Date", Tag.MULTIPLE), _single("Boolean", Tag.MULTIPLE), _single("Number", Tag.MULTIPLE), _single("Select", Tag.MULTIPLE), _single("Picture", Tag.MULTIPLE), _single("Composite", Tag.MULTIPLE), _single("Multiple", Tag.MULTIPLE)), _parameter("label", "string", false, 0, "", "readonly"), _plate()));
