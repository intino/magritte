...
public class Queue extends teseo.SubscriptionModel implements tara.magritte.tags.Component, tara.magritte.tags.Terminal {
	...
	public tara.magritte.Concept concept() {
		return this.graph().concept(teseo.Queue.class);
	}
