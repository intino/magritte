...
public class Exception extends teseo.Data implements tara.magritte.tags.Component, tara.magritte.tags.Terminal {
	protected teseo.rules.ExceptionCodes code;
	...
	public teseo.rules.ExceptionCodes code() {
		return code;
	}
	...
	public void code(teseo.rules.ExceptionCodes value) {
		this.code = value;
	}
	...
	public tara.magritte.Concept concept() {
		return this.graph().concept(teseo.Exception.class);
	}

	@Override
	protected void _load(java.lang.String name, java.util.List<?> values) {
		super._load(name, values);
		if (name.equalsIgnoreCase("code")) this.code = tara.magritte.loaders.WordLoader.load(values, teseo.rules.ExceptionCodes.class, this).get(0);
	...
	protected void _set(java.lang.String name, java.util.List<?> values) {
		...
		if (name.equalsIgnoreCase("code")) this.code = (teseo.rules.ExceptionCodes) values.get(0);
