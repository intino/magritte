...
import static io.intino.tara.plugin.lang.parser.TaraParserUtil.*;
...
public class TaraParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // (subNode | (metaIdentifier ruleContainer* parameters? identifier? facets? parent?)) (withTable | facetTarget? tags? anchor?)
