...
public class MethodTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("value", "date")), (condition("trigger", "type"))).add(literal("tara.magritte.Date")),
			...
			rule().add((condition("value", "date")), (condition("trigger", "list"))).add(literal("tara.magritte.Date")),
