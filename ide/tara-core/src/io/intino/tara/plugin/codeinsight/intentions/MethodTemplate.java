...
public class MethodTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("value", "instant")), (condition("trigger", "type"))).add(literal("java.time.Instant")),
			rule().add((condition("value", "date")), (condition("trigger", "type"))).add(literal("Date")),
			...
			rule().add((condition("value", "instant")), (condition("trigger", "list"))).add(literal("java.time.Instant")),
			rule().add((condition("value", "date")), (condition("trigger", "list"))).add(literal("Date")),
			...
			rule().add((condition("value", "type")), (condition("trigger", "list"))).add(literal("Concept"))
		);
		return this;
	}
}