...
public class GraphWrapper extends tara.magritte.GraphWrapper {
	...
	protected void update() {
		project = this.graph.rootList(Project.class).stream().findFirst().orElse(null);
	}

	@Override
	protected void addNode(tara.magritte.Node node) {
		if (node.is("Project")) this.project = node.as(Project.class);
	}
	...
	public class Create {
		...
		public Project project(java.lang.String groupId, java.lang.String version) {
			Project newElement = GraphWrapper.this.graph.createRoot(Project.class, namespace, name).as(Project.class);
