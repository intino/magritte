package legio.application;

import legio.*;

import java.util.*;

public class ApplicationProject extends legio.generatinglevel.GeneratingLevelProject implements tara.magritte.tags.Terminal {
	
	

	public ApplicationProject(tara.magritte.Node node) {
		super(node);
	}
