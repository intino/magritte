package legio.platform;

import legio.*;

import java.util.*;

public class PlatformProject extends legio.generatinglevel.GeneratingLevelProject implements tara.magritte.tags.Terminal {
	
	

	public PlatformProject(tara.magritte.Node node) {
		super(node);
	}
