package teseo.jmsrequest;

import teseo.*;

import java.util.*;

public class JMSRequestTrigger extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
	
	protected teseo.Trigger _trigger;

	public JMSRequestTrigger(tara.magritte.Node node) {
		super(node);
	}
