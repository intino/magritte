...
public class RESTService extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
	...
	protected teseo.rest.RESTService.Authenticated authenticated;
	protected teseo.rest.RESTService.AuthenticatedWithCertificate authenticatedWithCertificate;
	protected teseo.rest.RESTService.AuthenticatedWithPassword authenticatedWithPassword;
	protected java.util.List<teseo.Resource> resourceList = new java.util.ArrayList<>();
	protected teseo.rest.RESTService.Info info;
	protected teseo.rest.RESTService.Contact contact;
	protected teseo.rest.RESTService.License license;
	protected java.util.List<teseo.rest.RESTService.Tag> tagList = new java.util.ArrayList<>();
	...
	public teseo.rest.RESTService.Authenticated authenticated() {
		return authenticated;
	}

	public teseo.rest.RESTService.AuthenticatedWithCertificate authenticatedWithCertificate() {
		return authenticatedWithCertificate;
	}

	public teseo.rest.RESTService.AuthenticatedWithPassword authenticatedWithPassword() {
		return authenticatedWithPassword;
	}

	public java.util.List<teseo.Resource> resourceList() {
		return resourceList;
	}

	public teseo.Resource resource(int index) {
		return resourceList.get(index);
	}

	public java.util.List<teseo.Resource> resourceList(java.util.function.Predicate<teseo.Resource> predicate) {
		return resourceList().stream().filter(predicate).collect(java.util.stream.Collectors.toList());
	}

	public teseo.rest.RESTService.Info info() {
		return info;
	}

	public teseo.rest.RESTService.Contact contact() {
		return contact;
	}

	public teseo.rest.RESTService.License license() {
		return license;
	}

	public java.util.List<teseo.rest.RESTService.Tag> tagList() {
		return tagList;
	}

	public teseo.rest.RESTService.Tag tag(int index) {
		return tagList.get(index);
	}

	public java.util.List<teseo.rest.RESTService.Tag> tagList(java.util.function.Predicate<teseo.rest.RESTService.Tag> predicate) {
		return tagList().stream().filter(predicate).collect(java.util.stream.Collectors.toList());
	}

	public void authenticated(teseo.rest.RESTService.Authenticated value) {
		this.authenticated = value;
	}

	public void authenticatedWithCertificate(teseo.rest.RESTService.AuthenticatedWithCertificate value) {
		this.authenticatedWithCertificate = value;
	}

	public void authenticatedWithPassword(teseo.rest.RESTService.AuthenticatedWithPassword value) {
		this.authenticatedWithPassword = value;
	}

	

	public void info(teseo.rest.RESTService.Info value) {
		this.info = value;
	}

	public void contact(teseo.rest.RESTService.Contact value) {
		this.contact = value;
	}

	public void license(teseo.rest.RESTService.License value) {
		this.license = value;
	}
	...
	protected void addNode(tara.magritte.Node node) {
		super.addNode(node);
		if (node.is("REST#Service$Authenticated")) this.authenticated = node.as(teseo.rest.RESTService.Authenticated.class);
		if (node.is("REST#Service$AuthenticatedWithCertificate")) this.authenticatedWithCertificate = node.as(teseo.rest.RESTService.AuthenticatedWithCertificate.class);
		if (node.is("REST#Service$AuthenticatedWithPassword")) this.authenticatedWithPassword = node.as(teseo.rest.RESTService.AuthenticatedWithPassword.class);
		if (node.is("Resource")) this.resourceList.add(node.as(teseo.Resource.class));
		if (node.is("REST#Service$Info")) this.info = node.as(teseo.rest.RESTService.Info.class);
		if (node.is("REST#Service$Contact")) this.contact = node.as(teseo.rest.RESTService.Contact.class);
		if (node.is("REST#Service$License")) this.license = node.as(teseo.rest.RESTService.License.class);
		if (node.is("REST#Service$Tag")) this.tagList.add(node.as(teseo.rest.RESTService.Tag.class));
	}
    ...
    protected void removeNode(tara.magritte.Node node) {
        ...
        if (node.is("Resource")) this.resourceList.remove(node.as(teseo.Resource.class));
        ...
        if (node.is("REST#Service$Tag")) this.tagList.remove(node.as(teseo.rest.RESTService.Tag.class));
    }
	...
	public class Create {
		...
		public teseo.rest.RESTService.AuthenticatedWithCertificate authenticatedWithCertificate(java.net.URL store, java.lang.String storePassword) {
		    teseo.rest.RESTService.AuthenticatedWithCertificate newElement = graph().concept(teseo.rest.RESTService.AuthenticatedWithCertificate.class).createNode(name, node()).as(teseo.rest.RESTService.AuthenticatedWithCertificate.class);
		...
		public teseo.rest.RESTService.AuthenticatedWithPassword authenticatedWithPassword() {
		    teseo.rest.RESTService.AuthenticatedWithPassword newElement = graph().concept(teseo.rest.RESTService.AuthenticatedWithPassword.class).createNode(name, node()).as(teseo.rest.RESTService.AuthenticatedWithPassword.class);
		    return newElement;
		}

		public teseo.Resource resource(java.lang.String title, java.lang.String path, teseo.Resource.Type type) {
		    teseo.Resource newElement = graph().concept(teseo.Resource.class).createNode(name, node()).as(teseo.Resource.class);
		...
		public teseo.rest.RESTService.Info info(java.lang.String title, java.lang.String version) {
		    teseo.rest.RESTService.Info newElement = graph().concept(teseo.rest.RESTService.Info.class).createNode(name, node()).as(teseo.rest.RESTService.Info.class);
			newElement.node().set(newElement, "title", java.util.Collections.singletonList(title));
		...
		public teseo.rest.RESTService.Contact contact() {
		    teseo.rest.RESTService.Contact newElement = graph().concept(teseo.rest.RESTService.Contact.class).createNode(name, node()).as(teseo.rest.RESTService.Contact.class);
		    return newElement;
		}

		public teseo.rest.RESTService.License license() {
		    teseo.rest.RESTService.License newElement = graph().concept(teseo.rest.RESTService.License.class).createNode(name, node()).as(teseo.rest.RESTService.License.class);
		    return newElement;
		}

		public teseo.rest.RESTService.Tag tag() {
		    teseo.rest.RESTService.Tag newElement = graph().concept(teseo.rest.RESTService.Tag.class).createNode(name, node()).as(teseo.rest.RESTService.Tag.class);
		    return newElement;
		}
	...
	public static abstract class Authenticated extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.Authenticated.class);
		}
	...
	public static class AuthenticatedWithCertificate extends teseo.rest.RESTService.Authenticated implements tara.magritte.tags.Terminal {
		protected java.net.URL store;
		protected java.lang.String storePassword;
		protected java.util.List<teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers> allowedUsersList = new java.util.ArrayList<>();
		...
		public java.util.List<teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers> allowedUsersList() {
			return allowedUsersList;
		}

		public teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers allowedUsers(int index) {
			return allowedUsersList.get(index);
		}

		public java.util.List<teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers> allowedUsersList(java.util.function.Predicate<teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers> predicate) {
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.AuthenticatedWithCertificate.class);
		}

		@Override
		protected void addNode(tara.magritte.Node node) {
			super.addNode(node);
			if (node.is("REST#Service$AuthenticatedWithCertificate$AllowedUsers")) this.allowedUsersList.add(node.as(teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers.class));
		}

		@Override
	    protected void removeNode(tara.magritte.Node node) {
	        super.removeNode(node);
	        if (node.is("REST#Service$AuthenticatedWithCertificate$AllowedUsers")) this.allowedUsersList.remove(node.as(teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers.class));
	    }
		...
		public class Create extends teseo.rest.RESTService.Authenticated.Create {
			...
			public teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers allowedUsers(java.util.List<java.net.URL> certificate) {
			    teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers newElement = graph().concept(teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers.class).createNode(name, node()).as(teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers.class);
		...
		public static class AllowedUsers extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
			...
			public tara.magritte.Concept concept() {
				return this.graph().concept(teseo.rest.RESTService.AuthenticatedWithCertificate.AllowedUsers.class);
			}
	...
	public static class AuthenticatedWithPassword extends teseo.rest.RESTService.Authenticated implements tara.magritte.tags.Terminal {
		
		protected java.util.List<teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers> allowedUsersList = new java.util.ArrayList<>();

		public AuthenticatedWithPassword(tara.magritte.Node node) {
			super(node);
		}

		public java.util.List<teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers> allowedUsersList() {
			return allowedUsersList;
		}

		public teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers allowedUsers(int index) {
			return allowedUsersList.get(index);
		}

		public java.util.List<teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers> allowedUsersList(java.util.function.Predicate<teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers> predicate) {
			return allowedUsersList().stream().filter(predicate).collect(java.util.stream.Collectors.toList());
		}
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.AuthenticatedWithPassword.class);
		}

		@Override
		protected void addNode(tara.magritte.Node node) {
			super.addNode(node);
			if (node.is("REST#Service$AuthenticatedWithPassword$AllowedUsers")) this.allowedUsersList.add(node.as(teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers.class));
		}

		@Override
	    protected void removeNode(tara.magritte.Node node) {
	        super.removeNode(node);
	        if (node.is("REST#Service$AuthenticatedWithPassword$AllowedUsers")) this.allowedUsersList.remove(node.as(teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers.class));
	    }
		...
		public class Create extends teseo.rest.RESTService.Authenticated.Create {
			...
			public teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers allowedUsers(java.lang.String user, java.lang.String password) {
			    teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers newElement = graph().concept(teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers.class).createNode(name, node()).as(teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers.class);
		...
		public static class AllowedUsers extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
			...
			public tara.magritte.Concept concept() {
				return this.graph().concept(teseo.rest.RESTService.AuthenticatedWithPassword.AllowedUsers.class);
			}
	...
	public static class Info extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.Info.class);
		}
	...
	public static class Contact extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.Contact.class);
		}
	...
	public static class License extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.License.class);
		}
	...
	public static class Tag extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
		protected java.lang.String description;
		protected java.util.List<teseo.rest.RESTService.Tag.Document> documentList = new java.util.ArrayList<>();
		...
		public java.util.List<teseo.rest.RESTService.Tag.Document> documentList() {
			return documentList;
		}

		public teseo.rest.RESTService.Tag.Document document(int index) {
			return documentList.get(index);
		}

		public java.util.List<teseo.rest.RESTService.Tag.Document> documentList(java.util.function.Predicate<teseo.rest.RESTService.Tag.Document> predicate) {
		...
		public tara.magritte.Concept concept() {
			return this.graph().concept(teseo.rest.RESTService.Tag.class);
		}

		@Override
		protected void addNode(tara.magritte.Node node) {
			super.addNode(node);
			if (node.is("REST#Service$Tag$Document")) this.documentList.add(node.as(teseo.rest.RESTService.Tag.Document.class));
		}

		@Override
	    protected void removeNode(tara.magritte.Node node) {
	        super.removeNode(node);
	        if (node.is("REST#Service$Tag$Document")) this.documentList.remove(node.as(teseo.rest.RESTService.Tag.Document.class));
	    }
		...
		public class Create {
			...
			public teseo.rest.RESTService.Tag.Document document(java.lang.String url) {
			    teseo.rest.RESTService.Tag.Document newElement = graph().concept(teseo.rest.RESTService.Tag.Document.class).createNode(name, node()).as(teseo.rest.RESTService.Tag.Document.class);
		...
		public static class Document extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
			...
			public tara.magritte.Concept concept() {
				return this.graph().concept(teseo.rest.RESTService.Tag.Document.class);
			}
