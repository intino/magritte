package pandora.directorysentinel;
...
public class DirectorySentinelTask extends tara.magritte.Layer implements tara.magritte.tags.Terminal {
	...
	protected pandora.functions.DirectoryChecker check;
	protected pandora.Task _task;

	public DirectorySentinelTask(tara.magritte.Node node) {
		super(node);
	}
	...
	protected void _load(java.lang.String name, java.util.List<?> values) {
		...
		else if (name.equalsIgnoreCase("check")) this.check = tara.magritte.loaders.FunctionLoader.load(values, this, pandora.functions.DirectoryChecker.class).get(0);
	}
	...
	protected void _set(java.lang.String name, java.util.List<?> values) {
		...
		else if (name.equalsIgnoreCase("check")) this.check = tara.magritte.loaders.FunctionLoader.load(values.get(0), this, pandora.functions.DirectoryChecker.class);
	}
