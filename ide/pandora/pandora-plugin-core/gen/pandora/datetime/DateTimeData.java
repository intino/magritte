package pandora.datetime;

import pandora.*;

import java.util.*;

public class DateTimeData extends pandora.type.TypeData implements tara.magritte.tags.Terminal {
	protected java.lang.String format;

	public DateTimeData(tara.magritte.Node node) {
		super(node);
	}
