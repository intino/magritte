package pandora.shutdowntrigger;

import pandora.*;

import java.util.*;

public class ShutdownTriggerTask extends pandora.scheduled.ScheduledTask implements tara.magritte.tags.Terminal {
	
	protected pandora.Task _task;

	public ShutdownTriggerTask(tara.magritte.Node node) {
		super(node);
	}
