...
public class FormatTemplate extends Template {

	protected FormatTemplate(Locale locale, LineSeparator separator) {
		super(locale, separator);
	}

	public static Template create() {
		return new FormatTemplate(Locale.ENGLISH, CRLF).define();
	}
