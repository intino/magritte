...
public class TaraChildrenBodyImpl extends ASTWrapperPsiElement implements TaraChildrenBody {

  public TaraChildrenBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof TaraVisitor) ((TaraVisitor)visitor).visitChildrenBody(this);
