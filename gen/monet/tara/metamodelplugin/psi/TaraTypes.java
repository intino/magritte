...
import monet.tara.metamodelplugin.psi.impl.*;

public interface TaraTypes {

  IElementType ANNOTATION = new TaraElementType("ANNOTATION");
  IElementType ATTR_SIBLINGS = new TaraElementType("ATTR_SIBLINGS");
  ...
  IElementType CRLF = new TaraTokenType("CRLF");
  IElementType DEINDENT = new TaraTokenType("DEINDENT");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == ATTR_SIBLINGS) {
        return new TaraAttrSiblingsImpl(node);
      }
