...
public class Annotations {
	...
	public static final Annotation[] SUB_ANNOTATIONS = join(new Annotation[]{PROPERTY, NAMED, ABSTRACT, TERMINAL, ADDRESSED, AGGREGATED, CASE}, META_ANNOTATIONS);
	public static final Annotation[] HAS_ANNOTATIONS = new Annotation[]{AGGREGATED, SINGLE, REQUIRED};
