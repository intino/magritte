...
public final class ReferenceParameter extends ParameterConstraint {
	...
	public void check(Element element) throws SemanticException {
		...
		io.intino.magritte.lang.model.Parameter parameter = findParameter(parametrized.parameters(), this.facet, this.name, this.position);
		if (parameter == null) {
	...
	public boolean isConstraintOf(io.intino.magritte.lang.model.Parameter parameter) {
		io.intino.magritte.lang.model.Parameter expected = findParameter(parameter.container().parameters(), this.facet, this.name, this.position);
