...
import static io.intino.magritte.lang.model.Tag.AspectInstance;
...
public class RuleFactory {
	...
	public static Constraint.RejectOtherParameters rejectOtherParameters(List<Constraint.Parameter> parameters) {
		return new Constraint.RejectOtherParameters() {
			...
			public void check(Element element) throws SemanticException {
				...
				for (io.intino.magritte.lang.model.Parameter parameter : parametrized.parameters()) {
			...
			private boolean isAcceptable(io.intino.magritte.lang.model.Parameter parameter, List<Parameter> parameters) {
			...
			private boolean hasAspect(String requiredAspect, List<io.intino.magritte.lang.model.Aspect> aspects) {
				if (requiredAspect.isEmpty()) return true;
				for (io.intino.magritte.lang.model.Aspect aspect : aspects) if (aspect.type().equals(requiredAspect)) return true;
				return false;
			}
		};
	}
	...
	public static Constraint.RejectOtherAspects rejectOtherAspects(List<Constraint.Aspect> aspects) {
		return new Constraint.RejectOtherAspects() {
			...
			private boolean isAcceptable(List<Aspect> aspects, io.intino.magritte.lang.model.Aspect aspect) {
