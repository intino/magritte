...
//		TEMPLATES.put("CompilerWorkspaceConfiguration.java", IDE_TPL + SRC+ PROJECT_PATH + "compiler/-CompilerWorkspaceConfiguration.java");
		...
		ICONS.put("project.png", IDE_TPL + SRC + PROJECT_PATH + "metamodel/icons/project.png");
		ICONS.put("definition.png", IDE_TPL + SRC + PROJECT_PATH + "metamodel/icons/definition.png");
