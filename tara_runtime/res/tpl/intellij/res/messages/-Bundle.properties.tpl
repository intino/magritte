...
rename.prefix.based.definition.key.error.message=Could not rename definition key ''{1}'' based on prefix ''{0}'' by name ''{2}'', change prefix first
::projectName::.files.file.type.description=::projectName:: files
