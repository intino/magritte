...
public class ::projectProperName::FileStructureViewElement extends PsiTreeElementBase<::projectProperName::FileImpl> {

	protected ::projectProperName::FileStructureViewElement(::projectProperName::FileImpl propertiesFile) {
	...
	public Collection<StructureViewTreeElement> getChildrenBase() {
		...
		for (Definition definition : definitions)
			elements.add(new ::projectProperName::StructureViewElement(definition));
		return elements;
	}
	...
	public ItemPresentation getPresentation() {
		return new ItemPresentation() {
			public String getPresentableText() {
				return ::projectProperName::FileStructureViewElement.this.getPresentableText();
			}
