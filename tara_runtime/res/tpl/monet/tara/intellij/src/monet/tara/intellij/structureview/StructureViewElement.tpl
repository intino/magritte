...
public class ::projectProperName::StructureViewElement implements StructureViewTreeElement {

	private final Definition definition;
	private String myPresentableName;

	public ::projectProperName::StructureViewElement(Definition ::projectName::Definition) {
		...
		if (definition != null) {
			...
			if (definitions != null && !(definitions.length == 0)) {
				...
				for (Definition definition : definitions)
					treeElements.add(new ::projectProperName::StructureViewElement(definition));
