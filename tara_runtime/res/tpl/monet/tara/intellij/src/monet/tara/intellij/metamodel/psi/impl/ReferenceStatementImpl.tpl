...
public class ::projectProperName::ReferenceStatementImpl extends ASTWrapperPsiElement implements ::projectProperName::ReferenceStatement {

  public ::projectProperName::ReferenceStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ::projectProperName::Visitor) ((::projectProperName::Visitor)visitor).visitReferenceStatement(this);
  ...
  public ::projectProperName::VariableNames getVariableNames() {
    return findNotNullChildByClass(::projectProperName::VariableNames.class);
  }
