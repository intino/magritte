...
import monet.::projectName::.intellij.metamodel.psi.::projectProperName::ExtendedDefinition;
...
public class ::projectProperName::ReferenceStatementMixin extends ASTWrapperPsiElement {
	...
	public String getIdentifier() {
		return ::projectProperName::PsiImplUtil.getIdentifier((::projectProperName::ExtendedDefinition) this);
	}
