...
public class ::projectProperName::ModuleType extends ::projectProperName::ModuleTypeBase<::projectProperName::ModuleBuilderBase> {
	...
	public ModuleWizardStep[] createWizardSteps(@NotNull final WizardContext wizardContext,
	                                            @NotNull final ::projectProperName::ModuleBuilderBase moduleBuilder,
	...
	@NotNull
	@Override
	public ::projectProperName::ModuleBuilder createModuleBuilder() {
		return new ::projectProperName::ModuleBuilder();
	}
}
