...
public class ::projectProperName::RunConfiguration extends ModuleBasedConfiguration<RunConfigurationModule>
	...
	public ::projectProperName::RunConfiguration(final String name, final Project project, final ConfigurationFactory factory) {
	...
	public Collection<Module> getValidModules() {
		...
		final ::projectProperName::Runner scriptRunner = findConfiguration();
	...
	@Nullable
	private ::projectProperName::Runner findConfiguration() {
		return new Default::projectProperName::Runner();
	}
	...
	public RefactoringElementListener getRefactoringElementListener(PsiElement element) {
		final PsiClass classToRun = ::projectProperName::RunnerUtil.getRunningClass(element);
	...
	public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
		return new ::projectProperName::RunConfigurationEditor();
	}
