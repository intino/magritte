...
public class ::projectProperName::ModuleBuilderBase extends ModuleBuilder {

	private final DirectoryProjectGenerator myGenerator;

	public ::projectProperName::ModuleBuilderBase() {
		myGenerator = null;
	}
	...
	public ModuleType getModuleType() {
		return ::projectProperName::ModuleTypeBase.getInstance();
	}
