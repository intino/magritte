...
public class Default::projectProperName::Runner extends ::projectProperName::Runner {
...
//			ExecutionUtil.handleExecutionError(project, executor.getToolWindowId(), profile, new ExecutionException("::projectProperName:: is not configured"));
