...
public class TaraDoubleAttributeImpl extends ASTWrapperPsiElement implements TaraDoubleAttribute {

  public TaraDoubleAttributeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof TaraVisitor) ((TaraVisitor)visitor).visitDoubleAttribute(this);
