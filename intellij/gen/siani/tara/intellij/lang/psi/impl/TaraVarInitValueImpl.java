...
public class TaraVarInitValueImpl extends ASTWrapperPsiElement implements TaraVarInitValue {

  public TaraVarInitValueImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof TaraVisitor) ((TaraVisitor)visitor).visitVarInitValue(this);
