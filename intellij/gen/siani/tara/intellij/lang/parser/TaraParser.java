...
public class TaraParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_) {
    ...
    else if (root_ == LINK_VALUE) {
      result_ = linkValue(builder_, 0);
    }
    ...
    else if (root_ == VAR_INIT_VALUE) {
      result_ = varInitValue(builder_, 0);
    }
  ...
  private static boolean annotations_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeToken(builder_, COMPOSED);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean booleanAttribute_3_0_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = booleanAttribute_3_0_1_0(builder_, level_ + 1);
  ...
  // booleanValue+
  private static boolean booleanAttribute_3_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "booleanAttribute_3_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "booleanAttribute_3_0_1_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean conceptReference_3(PsiBuilder builder_, int level_) {
    ...
    conceptReference_3_0(builder_, level_ + 1);
    return true;
  }

  // IS annotations
  private static boolean conceptReference_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "conceptReference_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, IS);
  ...
  private static boolean dateAttribute_3_0_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dateAttribute_3_0_1_0(builder_, level_ + 1);
    if (!result_) result_ = emptyField(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // dateValue+
  private static boolean dateAttribute_3_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dateAttribute_3_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "dateAttribute_3_0_1_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean doubleAttribute_4_0_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = doubleAttribute_4_0_1_0_0(builder_, level_ + 1);
  ...
  // doubleValue+
  private static boolean doubleAttribute_4_0_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "doubleAttribute_4_0_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "doubleAttribute_4_0_1_0_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  public static boolean facetApply(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, facetApply_1(builder_, level_ + 1));
  ...
  private static boolean integerAttribute_4_0_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = integerAttribute_4_0_1_0_0(builder_, level_ + 1);
  ...
  // integerValue+
  private static boolean integerAttribute_4_0_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "integerAttribute_4_0_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "integerAttribute_4_0_1_0_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  public static boolean linkValue(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "linkValue")) return false;
    if (!nextTokenIs(builder_, "<link value>", ADDRESS_VALUE, IDENTIFIER_KEY)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, "<link value>");
    result_ = consumeToken(builder_, ADDRESS_VALUE);
    if (!result_) result_ = identifierReference(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, LINK_VALUE, result_, false, null);
    return result_;
  }
  ...
  private static boolean naturalAttribute_4_0_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = naturalAttribute_4_0_1_0_0(builder_, level_ + 1);
  ...
  // naturalValue+
  private static boolean naturalAttribute_4_0_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "naturalAttribute_4_0_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "naturalAttribute_4_0_1_0_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean stringAttribute_3_0_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = stringAttribute_3_0_1_0(builder_, level_ + 1);
    if (!result_) result_ = emptyField(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // stringValue+
  private static boolean stringAttribute_3_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "stringAttribute_3_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = stringValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!stringValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "stringAttribute_3_0_1_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  /* ********************************************************** */
  // TUPLE_TYPE   LIST?  IDENTIFIER_KEY (EQUALS (doubleValue+  | emptyField))?
  static boolean tupleAttribute(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tupleAttribute")) return false;
    if (!nextTokenIs(builder_, TUPLE_TYPE)) return false;
    boolean result_;
    boolean pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
    result_ = consumeToken(builder_, TUPLE_TYPE);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, tupleAttribute_1(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, IDENTIFIER_KEY)) && result_;
    result_ = pinned_ && tupleAttribute_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }

  // LIST?
  private static boolean tupleAttribute_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tupleAttribute_1")) return false;
    consumeToken(builder_, LIST);
    return true;
  }

  // (EQUALS (doubleValue+  | emptyField))?
  private static boolean tupleAttribute_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tupleAttribute_3")) return false;
    tupleAttribute_3_0(builder_, level_ + 1);
    return true;
  }

  // EQUALS (doubleValue+  | emptyField)
  private static boolean tupleAttribute_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tupleAttribute_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, EQUALS);
    result_ = result_ && tupleAttribute_3_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // doubleValue+  | emptyField
  private static boolean tupleAttribute_3_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tupleAttribute_3_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = tupleAttribute_3_0_1_0(builder_, level_ + 1);
    if (!result_) result_ = emptyField(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // doubleValue+
  private static boolean tupleAttribute_3_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "tupleAttribute_3_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = doubleValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!doubleValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "tupleAttribute_3_0_1_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  public static boolean varInit(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 2
    result_ = result_ && varInitValue(builder_, level_ + 1);
  ...
  //                 | integerValue+ measure?
  //                 | doubleValue+  measure?
  public static boolean varInitValue(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, "<var init value>");
    result_ = emptyField(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_1(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_2(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_3(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_4(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_5(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_6(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_7(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_8(builder_, level_ + 1);
    if (!result_) result_ = varInitValue_9(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, VAR_INIT_VALUE, result_, false, null);
    return result_;
  }

  // identifier+
  private static boolean varInitValue_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = identifier(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "varInitValue_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // linkValue+
  private static boolean varInitValue_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = linkValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!linkValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // stringValue+
  private static boolean varInitValue_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_3")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = stringValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!stringValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_3", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // booleanValue+
  private static boolean varInitValue_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = booleanValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!booleanValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_4", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // dateValue+
  private static boolean varInitValue_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = dateValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!dateValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_5", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // coordinateValue+
  private static boolean varInitValue_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = coordinateValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!coordinateValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_6", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // naturalValue+ measure?
  private static boolean varInitValue_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_7")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = varInitValue_7_0(builder_, level_ + 1);
    result_ = result_ && varInitValue_7_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // naturalValue+
  private static boolean varInitValue_7_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_7_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = naturalValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!naturalValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_7_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // measure?
  private static boolean varInitValue_7_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_7_1")) return false;
    measure(builder_, level_ + 1);
    return true;
  }

  // integerValue+ measure?
  private static boolean varInitValue_8(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_8")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = varInitValue_8_0(builder_, level_ + 1);
    result_ = result_ && varInitValue_8_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // integerValue+
  private static boolean varInitValue_8_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_8_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = integerValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!integerValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_8_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // measure?
  private static boolean varInitValue_8_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_8_1")) return false;
    measure(builder_, level_ + 1);
    return true;
  }

  // doubleValue+  measure?
  private static boolean varInitValue_9(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_9")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = varInitValue_9_0(builder_, level_ + 1);
    result_ = result_ && varInitValue_9_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // doubleValue+
  private static boolean varInitValue_9_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_9_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = doubleValue(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!doubleValue(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "varInitValue_9_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // measure?
  private static boolean varInitValue_9_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varInitValue_9_1")) return false;
    measure(builder_, level_ + 1);
    return true;
  }
  ...
  // 		dateAttribute | tupleAttribute | resource | referenceAttribute | word
  static boolean variableDeclaration(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = tupleAttribute(builder_, level_ + 1);
