...
public class TaraParser implements PsiParser {
	...
	public static boolean doubleValue(PsiBuilder builder_, int level_) {
		...
		boolean result_;
		Marker marker_ = enter_section_(builder_, level_, _NONE_, "<double defaultValue>");
	...
	public static boolean integerValue(PsiBuilder builder_, int level_) {
		...
		if (!nextTokenIs(builder_, "<integer defaultValue>", NATURAL_VALUE_KEY, NEGATIVE_VALUE_KEY)) return false;
		boolean result_;
		Marker marker_ = enter_section_(builder_, level_, _NONE_, "<integer defaultValue>");
		result_ = consumeToken(builder_, NATURAL_VALUE_KEY);
		if (!result_) result_ = consumeToken(builder_, NEGATIVE_VALUE_KEY);
	...
	public static boolean parameterValue(PsiBuilder builder_, int level_) {
		...
		boolean result_;
		Marker marker_ = enter_section_(builder_, level_, _NONE_, "<parameter defaultValue>");
	...
	public static boolean stringValue(PsiBuilder builder_, int level_) {
		...
		boolean result_;
		Marker marker_ = enter_section_(builder_, level_, _NONE_, "<string defaultValue>");
