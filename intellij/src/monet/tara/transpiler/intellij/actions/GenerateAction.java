package monet.tara.transpiler.intellij.actions;
...
import monet.tara.transpiler.intellij.plugingeneration.PluginGenerator;
...
public class GenerateAction extends AnAction implements DumbAware {
	...
	private static final Logger LOG = Logger.getInstance("monet.tara.transpiler.intellij.actions.GenerateAction");
				...
				ApplicationManager.getApplication().runReadAction(new Runnable() {
					...
					public void run() {
						...
						try {
							...
							Notifications.Bus.notify(new Notification("Plugin Generator",
								taraFiles[0].getProject().getName() + " plugin generation failed",
