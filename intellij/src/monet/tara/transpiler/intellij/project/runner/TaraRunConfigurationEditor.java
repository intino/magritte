package monet.tara.transpiler.intellij.project.runner;
...
public class TaraRunConfigurationEditor extends SettingsEditor<TaraRunConfiguration> implements PanelWithAnchor {
	...
	public TaraRunConfigurationEditor() {
		...
		final BrowseFilesListener scriptBrowseListener = new BrowseFilesListener(scriptPathField,
				...
				new FileChooserDescriptor(true, false, false, false, false, false) {
					public boolean isFileSelectable(VirtualFile file) {
						return file.getFileType() == TaraFileType.INSTANCE;
					}
				});
	...
	public void resetEditorFrom(TaraRunConfiguration configuration) {
	...
	public void applyEditorTo(TaraRunConfiguration configuration) throws ConfigurationException {
