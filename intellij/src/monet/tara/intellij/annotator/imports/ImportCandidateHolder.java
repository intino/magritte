...
import monet.tara.intellij.metamodel.psi.TaraHeader;
...
public class ImportCandidateHolder implements Comparable {
	...
	private final TaraImportStatement myImportElement;
	...
	public ImportCandidateHolder(
		...
		@Nullable TaraImportStatement importElement, @Nullable QualifiedName path
	) {
		myFile = file;
	...
	public TaraImportStatement getImportElement() {
	 ...
	 */
	public static String getQualifiedName(String name, QualifiedName importPath, TaraImportStatement source) {
		StringBuilder sb = new StringBuilder();
		if (source != null) {
			PsiElement parent = source.getParent();
			if (parent instanceof TaraHeader) {
				sb.append(name);
			} else {
