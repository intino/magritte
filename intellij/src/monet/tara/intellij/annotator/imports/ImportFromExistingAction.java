...
public class ImportFromExistingAction implements QuestionAction {
	 ...
	 */
	public ImportFromExistingAction(@NotNull Concept target, @NotNull ArrayList<ImportCandidateHolder> sources, String name,
...
//					.setTitle(myUseQualifiedImport ? TaraBundle.message("ACT.qualify.with.module") : TaraBundle.message("ACT.from.some.module.import"))
...
//		TaraImportStatement src = item.getImportElement();
//		if (src != null) {
...
//		new WriteCommandAction(src.getProject(), TaraBundle.message("ACT.CMD.use.import"), myTarget.getContainingFile()) {
//			@Override
