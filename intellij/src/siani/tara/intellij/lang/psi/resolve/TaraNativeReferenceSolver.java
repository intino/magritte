...
public class TaraNativeReferenceSolver extends TaraReferenceSolver {

	private final Allow.Parameter parameterAllow;

	public TaraNativeReferenceSolver(PsiElement element, TextRange range, Allow.Parameter parameterAllow) {
		super(element, range);
	...
	@Nullable
	@Override
	public PsiElement resolve() {//TODO
		return myElement;
	}
