...
public class AddAnnotationFix implements IntentionAction {
	...
	public AddAnnotationFix(Concept concept, Annotations.Annotation annotation) {
		...
		WriteCommandAction action = new WriteCommandAction(project, file) {
			...
			protected void run(@NotNull Result result) throws Throwable {
				...
				if (annotationsAndFacets != null)
					annotationsAndFacets.getAnnotationsList().add(
						TaraElementFactory.getInstance(concept.getProject()).createAnnotation(annotation.getName()));
				else {
