...
Concept Entity as Form <has-code extensible>
    ...
    from <multiple>
        ...
        Concept Field as BooleanField

        ' Añadir para incluir un campo texto en el formulario
        Concept F<caret>ield as TextField
            ...
            Concept as Edition <optional>
                ...
                from <multiple>
                    ...
                    Concept Rule abstract as Length
                    Concept Length as MaxLength { var Natural value }
                    Concept Length as MinLength { var Natural value }
                    Concept Rule as Mode
                        var Word mode { Uppercase; Lowercase; Sentence; Title }

                    ' Añadir para indicar un patrón de edición del campo
                    Concept Rule as Pattern
        ...
        Concept <caret>Field as DateField
            var Word precision
                Years
                Months
                Days
            ...
            Concept as Edition
                from
                    Concept abstract as Rule
                    Concept Rule as TodayIsTheLatestDate
                    Concept Rule as TodayIsTheEarliestDate

        ' Añadir para incluir un campo de selección en el formulario
        Concept Field as SelectField
            var Source source
            new T<caret>hesaurus <multiple optional>
            Concept as Edition <optional>
                ...
                from <optional>
                    ...
                    Concept Select as Root
                    Concept Select as Internal
                    Concept Select as Leaf
                    Concept Select as FromField
                        var Field field
                    Concept Select as FromTerm
                        var Term term
                        Concept as Depth
                            var Natural depth
        ...
        Concept Field as CompositeField
            new Field <multiple>
            Concept as View <optional>
