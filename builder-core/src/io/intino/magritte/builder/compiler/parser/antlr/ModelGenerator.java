package io.intino.magritte.builder.compiler.parser.antlr;
...
import io.intino.magritte.builder.compiler.model.*;
...
public class ModelGenerator extends TaraGrammarBaseListener {
	...
	private void addTags(TagsContext ctx, Node node) {
		if (ctx == null) return;
