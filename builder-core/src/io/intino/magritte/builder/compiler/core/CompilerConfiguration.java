...
import io.intino.magritte.builder.compiler.semantic.LanguageLoader;
...
import static io.intino.magritte.builder.compiler.semantic.LanguageLoader.getLanguagePath;
...
public class CompilerConfiguration implements Cloneable {
	...
	public class Language {
		...
		private io.intino.magritte.Language loadLanguage() {
			try {
				final io.intino.magritte.Language language = LanguageLoader.load(name, version, languagesDirectory().getAbsolutePath());
