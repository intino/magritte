...
import static siani.tara.magritte.io.StashWriter.stashOf;
...
public class AcceptedStashWriter {
	...
	public void should_create_stash_with_resources() throws Exception {
		...
		assertThat(customer.root.components[2].variables[0].value.getClass().toString(), is("class Stash$Blob"));
		...
		assertThat(customer.root.components[3].variables[0].value.getClass().toString(), is("class Stash$Blob"));
