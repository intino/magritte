...
public class InstantLoaderTest {
	...
	public void load() throws Exception {
		List<Instant> list = InstantLoader.load(asList(Instant.parse("2013-01-12T22:22:22Z").toEpochMilli(), "$@io.intino.magritte.framework.natives.CodedInstant"), new MockLayer(null));
