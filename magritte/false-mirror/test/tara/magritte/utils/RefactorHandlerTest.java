...
public class RefactorHandlerTest {
	...
	@Ignore("Only execute this is Engine file is not in res folder")@Test
	...
	@Ignore("Only execute this is Domain file is not in res folder")@Test
