...
//		for (NodeImpl inner : node.getInnerNodes()) {
...
//	}
//
//	private void removeFromNode(DeclaredNode node, List<NodeImpl> toRemove) {
//		for (NodeImpl removeNode : toRemove) node.getInnerNodes().remove(removeNode);
//	}
//
...
//			List<NodeImpl> destinies = new ArrayList();
...
//	}
//
//	private void resolveDestiniesOfTarget(NodeImpl facetNode, FacetTarget facetTarget, List<NodeImpl> destinies) throws DependencyException {
//		NodeImpl node;
...
//	}
//
//	private void addAllowedFacetsToDestinies(DeclaredNode facetNode, List<NodeImpl> targets, FacetTarget facet) {
//		for (NodeImpl target : targets) {
