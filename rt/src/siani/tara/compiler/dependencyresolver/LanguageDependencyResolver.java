...
public class LanguageDependencyResolver {
...
//				Node parentNode = language.searchNode(facet.getName());
...
//		for (Node parentNode : this.language.getNodeTable())
...
////					addInheritedTypes(language.get(clone.getType()).getName(), (Reference) clone);
//			}
...
//		List<Node> instances = new ArrayList<>();
//		for (Node instance : model.getNodeTable())
//			if (instance.getObject().getType().equals(metaNode.getName()) && language.searchNodeClass(instance).equals(metaNode))
//				instances.add(instance);
//		return instances;
//	}
//
...
//		for (Node node : language.getNodeTable()) {
