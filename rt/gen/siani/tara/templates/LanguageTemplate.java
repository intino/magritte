...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "tags"))).add(literal("Tag.")).add(mark("value", "tag")),
			rule().add((condition("value", "TERMINAL_INSTANCE")), (condition("trigger", "tag"))).add(literal("TerminalInstance")),
