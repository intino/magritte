...
public class BoxUnitTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "variable")), (condition("type", "reference")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new magritte.Reference[]{")).add(mark("variableValue", "ref").multiple(", ")).add(literal("}))")),
			rule().add((condition("trigger", "ref"))).add(literal("ref(\"")).add(mark("variableValue")).add(literal("\")")),
			rule().add((condition("type", "variable")), (condition("type", "file")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new magritte.primitives.Resource[]{")).add(mark("variableValue", "file").multiple(", ")).add(literal("}))")),
			rule().add((condition("trigger", "file"))).add(literal("resource(in(\"")).add(mark("value")).add(literal("\"))")),
			rule().add((condition("type", "variable")), (condition("type", "native")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".let(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("variableValue", "native")).add(literal(")")),
			rule().add((condition("trigger", "native")), not(condition("value", "null"))).add(literal("new ")).add(mark("value")).add(literal("()")),
			...
			rule().add((condition("type", "Variable")), (condition("type", "string")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new String[]{")).add(mark("variableValue", "quoted").multiple(", ")).add(literal("}))")),
			rule().add((condition("type", "Variable")), (condition("type", "integer")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new int[]{")).add(mark("variableValue").multiple(", ")).add(literal("}))")),
			rule().add((condition("type", "Variable")), (condition("type", "double")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new double[]{")).add(mark("variableValue").multiple(", ")).add(literal("}))")),
			rule().add((condition("type", "Variable")), (condition("type", "date")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new Date[]{")).add(mark("variableValue", "date").multiple(", ")).add(literal("}))")),
			rule().add((condition("trigger", "date"))).add(literal("asDate(\"")).add(mark("value")).add(literal("\")")),
			rule().add((condition("type", "Variable")), (condition("type", "boolean")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("private")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new boolean[]{")).add(mark("variableValue").multiple(", ")).add(literal("}))")),
