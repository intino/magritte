...
public class BoxUnitTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "intention")), (condition("trigger", "intention"))).add(literal("public static class ")).add(mark("path")).add(literal(" ")).add(expression().add(literal("extends ")).add(mark("generatedLanguage", "lowerCase")).add(literal(".")).add(mark("container"))).add(literal(" implements ")).add(mark("parentIntention", "lowercase")).add(literal(".natives.")).add(mark("interface", "FirstUppercase")).add(literal(" {\n    @Override\n    ")).add(mark("signature")).add(literal(" {\n        ")).add(mark("body")).add(literal("\n    }\n}")),
			...
			rule().add((condition("type", "variable")), (condition("type", "target")), (condition("type", "word")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"!")).add(mark("node")).add(literal(":")).add(mark("name")).add(literal("<")).add(mark("target")).add(literal("\", ")).add(mark("multiple")).add(literal("(")).add(mark("variableValue").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "variable")), (condition("type", "target")), (condition("type", "reference")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"!")).add(mark("node")).add(literal(":")).add(mark("name")).add(literal("<")).add(mark("target")).add(literal("\", ")).add(mark("multiple")).add(literal("(ref(")).add(mark("variableValue", "quoted").multiple(", ")).add(literal(")))")),
			rule().add((condition("type", "variable")), (condition("type", "target")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"!")).add(mark("node")).add(literal(":")).add(mark("name")).add(literal("<")).add(mark("target")).add(literal("\", ")).add(mark("multiple")).add(literal("(")).add(mark("variableValue", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "variable")), (condition("type", "reference")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(ref(")).add(mark("variableValue", "quoted").multiple(", ")).add(literal(")))")),
			...
			rule().add((condition("type", "variable")), (condition("type", "native")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("name")).add(literal("\", ")).add(mark("variableValue", "native")).add(literal(")")),
			rule().add((condition("trigger", "native")), (condition("value", "null"))).add(literal("nullBehavior()")),
			rule().add((condition("type", "variable")), (condition("type", "word")), (condition("slot", "variableValue")), (condition("trigger", "variable"))).add(literal(".set(\"")).add(mark("terminal")).add(mark("name")).add(literal("\", ")).add(mark("multiple")).add(literal("(new String[]{")).add(mark("variableValue", "quoted").multiple(", ")).add(literal("}))")),
