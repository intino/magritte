...
public class BoxUnitTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "include")), (condition("type", "key")), (condition("type", "case")), (condition("trigger", "include"))).add(literal(".has($(")).add(mark("value")).add(literal("))")),
			rule().add((condition("type", "include")), not(condition("type", "key")), (condition("type", "case")), (condition("trigger", "include"))).add(literal(".has(")).add(mark("value", "key")).add(literal(")")),
