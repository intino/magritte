...
public LanguageTemplate(Locale locale, Encoding encoding) {
	...
	public static Template template() {
		return new LanguageTemplate(Locale.ENGLISH, Encoding.with("UTF-8", LF));
	}
    ...
    public void definition() {
        ...
        rule().add(condition("type", "require"), condition("type", "parameter"), condition("type", "none"), condition("trigger", "require")).add(literal("_noneIncludes()")),
