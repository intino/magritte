...
public class TaraCRunnerTest {
	...
	public void MonetAnimalesM2() {
		TaracRunner.main(new String[]{"--gen-plugin", home + "/workspace/tara/rt/res_test/monetTestM2.txt"});
	}

	@Test
	public void MonetShopM2() {
		TaracRunner.main(new String[]{"--gen-plugin", home + "/workspace/tara/rt/res_test/monetShopM2.txt"});
	}
