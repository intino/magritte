...
annotation.extensible.key.warning.message=Extensible definition without extensions
annotation.extensible.key.error.message=Unsupported extensible out of extensible context
annotation.extension.extensible.key.error.message=Unsupported both extension in the same context
