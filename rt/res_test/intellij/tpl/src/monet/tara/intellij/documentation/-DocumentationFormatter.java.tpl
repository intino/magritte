...
public class ::projectProperName::DocumentationFormatter {

	private static final Logger LOG = Logger.getInstance(::projectProperName::DocumentationFormatter.class.getName());
