...
public class MetaIdentifierMixin extends ASTWrapperPsiElement {
	...
	public PsiReference[] getReferences() {
		return new PsiReference[]{new ::projectProperName::MetaReferenceSolver((MetaIdentifier) this, new TextRange(0, getIdentifier().length()))};
	}

	\@Nullable
	\@Override
	public PsiReference getReference() {
		PsiReference[] references = new PsiReference[]{new ::projectProperName::MetaReferenceSolver((MetaIdentifier) this, new TextRange(0, getIdentifier().length()))};
