...
public class ImportFromExistingAction implements QuestionAction {
	Definition myTarget;
	ArrayList<ImportCandidateHolder> mySources; // list of <import, imported_item>
	String myName;
	 ...
	 */
	public ImportFromExistingAction(\@NotNull Definition target, \@NotNull ArrayList<ImportCandidateHolder> sources, String name,
...
//					.setTitle(myUseQualifiedImport ? ::projectProperName::Bundle.message("ACT.qualify.with.module") \: ::projectProperName::Bundle.message("ACT.from.some.module.import"))
...
//		::projectProperName::ImportStatement src = item.getImportElement();
//		if (src != null) {
...
//		new WriteCommandAction(src.getProject(), ::projectProperName::Bundle.message("ACT.CMD.use.import"), myTarget.getContainingFile()) {
//			\@Override
