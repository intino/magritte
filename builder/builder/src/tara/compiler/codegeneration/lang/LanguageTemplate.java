...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "instanceRule")), (condition("trigger", "rule"))).add(literal("new tara.lang.model.rules.variable.InstanceRule(")).add(expression().add(mark("parameters", "quoted")).add(literal(","))).add(literal(")")),
