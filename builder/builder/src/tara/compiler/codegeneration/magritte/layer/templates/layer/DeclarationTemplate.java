...
public class DeclarationTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable & Word & owner & reactive")), not(condition("type", "OutDefined | inherited")), (condition("trigger", "declaration"))).add(literal("protected tara.magritte.Expression<")).add(mark("type", "firstUpperCase")).add(literal("> ")).add(mark("name", "javaValidName", "firstLowerCase", "javaValidWord")).add(literal(";\n\npublic enum ")).add(mark("name", "firstUpperCase", "javaValidWord")).add(literal(" {\n\t")).add(mark("words").multiple(", ")).add(literal(";\n}")),
			...
			rule().add((condition("type", "Variable")), (condition("type", "owner")), (condition("type", "concept")), not(condition("type", "multiple | inherited | overriden | instance")), (condition("trigger", "declaration"))).add(literal("protected tara.magritte.Concept ")).add(mark("name", "javaValidName", "firstLowerCase", "javaValidWord")).add(literal(";")),
