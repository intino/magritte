...
public class DeclarationTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "Variable & Word & multiple & owner & reactive")), not(condition("type", "outDefined | inherited")), (condition("trigger", "declaration"))).add(literal("protected io.intino.magritte.Expression<java.util.List<")).add(mark("type", "firstUpperCase")).add(literal(">> ")).add(mark("name", "javaValidWord")).add(literal(";\n\npublic enum ")).add(mark("name", "javaValidName", "javaValidWord", "firstUpperCase")).add(literal(" {\n\t")).add(mark("words").multiple(", ")).add(literal(";\n}")),
			...
			rule().add((condition("type", "Variable & Word & owner & reactive")), not(condition("type", "OutDefined | inherited")), (condition("trigger", "declaration"))).add(literal("protected io.intino.magritte.Expression<")).add(mark("type", "firstUpperCase")).add(literal("> ")).add(mark("name", "javaValidName", "firstLowerCase", "javaValidWord")).add(literal(";\n\npublic enum ")).add(mark("name", "firstUpperCase", "javaValidWord")).add(literal(" {\n\t")).add(mark("words").multiple(", ")).add(literal(";\n}")),
			...
			rule().add((condition("type", "Variable & owner & concept & multiple")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "declaration"))).add(literal("protected java.util.List<io.intino.magritte.Concept> ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(" = new java.util.ArrayList<>();")),
			rule().add((condition("type", "Variable & reactive & owner & multiple")), not(condition("type", "inherited")), not(condition("type", "overriden")), (condition("trigger", "declaration"))).add(literal("protected io.intino.magritte.Expression<java.util.List<")).add(mark("type", "fullType", "reference")).add(literal(">> ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(";")),
			rule().add((condition("type", "Variable & reactive & owner")), not(condition("type", "inherited")), not(condition("type", "multiple")), not(condition("type", "overriden")), (condition("trigger", "declaration"))).add(literal("protected io.intino.magritte.Expression<")).add(mark("type", "fullType", "reference")).add(literal("> ")).add(mark("name", "firstLowerCase", "javaValidWord")).add(literal(";")),
			...
			rule().add((condition("type", "Variable")), (condition("type", "owner")), (condition("type", "concept")), not(condition("type", "multiple | inherited | overriden | instance")), (condition("trigger", "declaration"))).add(literal("protected io.intino.magritte.Concept ")).add(mark("name", "javaValidName", "firstLowerCase", "javaValidWord")).add(literal(";")),
