...
public class DeclarationTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable")), (condition("type", "owner")), (condition("type", "concept")), not(condition("type", "multiple | inherited | overriden | instance")), (condition("trigger", "declaration"))).add(literal("protected io.intino.tara.magritte.Concept ")).add(mark("name", "javaValidName", "firstLowerCase", "javaValidWord")).add(literal(";")),
