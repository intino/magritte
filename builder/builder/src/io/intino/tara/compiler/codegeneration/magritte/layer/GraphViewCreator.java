...
public class GraphViewCreator extends Generator implements TemplateTags {

	private final Level modelLevel;

	public GraphViewCreator(Language language, String outDSL, Level modelLevel, String workingPackage, String languageWorkingPackage) {
	...
	public String create(Model model) {
		...
		return Format.customize(GraphViewTemplate.create()).format(frame);
	}
