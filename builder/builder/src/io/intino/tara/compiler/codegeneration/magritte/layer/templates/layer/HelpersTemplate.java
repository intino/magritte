...
public class HelpersTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("value", "datex")), (condition("trigger", "variableType"))).add(literal("io.intino.tara.magritte.type.DateX")),
			rule().add((condition("value", "instantx")), (condition("trigger", "variableType"))).add(literal("io.intino.tara.magritte.types.InstantX")),
			...
			rule().add((condition("value", "resource")), (condition("trigger", "variableType"))).add(literal("io.intino.tara.magritte.types.ResX")),
			...
			rule().add((condition("value", "resource")), (condition("trigger", "fulltype"))).add(literal("io.intino.tara.magritte.types.ResX")),
			...
			rule().add((condition("value", "datex")), (condition("trigger", "fullType"))).add(literal("io.intino.tara.magritte.types.DateX")),
			rule().add((condition("value", "instantx")), (condition("trigger", "fullType"))).add(literal("io.intino.tara.magritte.types.InstantX")),
