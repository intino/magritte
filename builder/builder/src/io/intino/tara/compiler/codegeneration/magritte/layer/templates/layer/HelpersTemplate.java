...
public class HelpersTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
				rule().condition((attribute("", "datex")), (trigger("variabletype"))).output(literal("io.intino.tara.magritte.type.DateX")),
				...
				rule().condition((attribute("", "date")), (trigger("fulltype"))).output(literal("io.intino.tara.magritte.types.Date")),
