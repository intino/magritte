...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
				rule().add((condition("type", "Model"))).add(literal("package tara.dsl;\n\nimport io.intino.tara.lang.model.Tag;\n\nimport java.util.Locale;\nimport static io.intino.tara.lang.semantics.constraints.RuleFactory.*;\n\npublic class ")).add(mark("name", "reference", "FirstUpperCase")).add(literal(" extends io.intino.tara.dsl.Tara {\n\tpublic ")).add(mark("name", "reference", "FirstUpperCase")).add(literal("() {\n\t\t")).add(mark("node", "super").multiple("\n")).add(literal("\n\t\t")).add(mark("root", "call").multiple("\n")).add(literal("\n\t}\n\n\t")).add(mark("root", "method").multiple("\n")).add(literal("\n\n\t@Override\n\tpublic String languageName() {\n\t\treturn \"")).add(mark("name", "FirstUpperCase")).add(literal("\";\n\t}\n\n\t@Override\n    public Locale locale() {\n        return ")).add(mark("locale")).add(literal(";\n    }\n\n    @Override\n    public boolean isTerminalLanguage() {\n        return ")).add(mark("terminal")).add(literal(";\n    }\n\n\t@Override\n\tpublic String metaLanguage() {\n\t\treturn ")).add(mark("metaLanguage", "quoted")).add(literal(";\n\t}\n}")),
				rule().add((condition("type", "instance")), (condition("trigger", "super"))).add(literal("declare(")).add(mark("qn", "quoted")).add(literal(", java.util.Arrays.asList(")).add(mark("nodeType", "quoted").multiple(", ")).add(literal("), ")).add(mark("path", "quoted")).add(literal(");")),
				rule().add((condition("type", "node")), (condition("trigger", "super"))).add(literal("def(\"")).add(mark("name")).add(literal("\").with(context(")).add(expression().add(mark("nodeType"))).add(literal(")")).add(expression().add(literal(".")).add(mark("constraints"))).add(expression().add(literal(".")).add(mark("assumptions"))).add(expression().add(literal(".")).add(mark("doc"))).add(literal(");")),
				rule().add((condition("trigger", "call"))).add(literal("Root")).add(mark("number")).add(literal(".load(this);")),
				rule().add((condition("trigger", "method"))).add(literal("private static class Root")).add(mark("number")).add(literal(" {\n\tprivate static void load(")).add(mark("language", "firstUpperCase")).add(literal(" self) {\n\t\t")).add(mark("node").multiple("\n")).add(literal("\n\t}\n}")),
				rule().add((condition("type", "instance")), (condition("trigger", "node"))).add(literal("self.declare(")).add(mark("qn", "quoted")).add(literal(", java.util.Arrays.asList(")).add(mark("nodeType", "quoted").multiple(", ")).add(literal("), ")).add(mark("path", "quoted")).add(literal(");")),
			...
			rule().add((condition("type", "constraint")), (condition("type", "facet")), (condition("trigger", "constraint"))).add(literal("facet(\"")).add(mark("value")).add(literal("\"")).add(expression().add(literal(", ")).add(mark("terminal")).or(expression().add(literal(", false")))).add(expression().add(literal(", ")).add(mark("required")).or(expression().add(literal(", false")))).add(literal(", new String[]{")).add(mark("with", "quoted").multiple(", ")).add(literal("}, new String[]{")).add(mark("without", "quoted").multiple(", ")).add(literal("})")).add(expression().add(literal(".has(")).add(mark("constraint").multiple(", ")).add(literal(")"))),
			...
			rule().add((condition("type", "rule & size")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.Size(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(expression().add(literal(", ")).add(mark("into", "size"))).add(literal(")")),
			rule().add((condition("type", "nativeObjectRule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.NativeObjectRule(\"")).add(mark("type")).add(literal("\")")),
			rule().add((condition("type", "nativeReferenceRule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.NativeReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "nativerule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.NativeRule(\"")).add(mark("interfaceClass")).add(literal("\", \"")).add(mark("signature")).add(literal("\", java.util.Arrays.asList(")).add(mark("imports", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "wordrule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal(")")).add(expression().add(literal(", ")).add(mark("externalWordClass", "quoted"))).add(literal(")")),
			rule().add((condition("type", "referenceRule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.ReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "doubleRule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.DoubleRule(")).add(mark("min", "cast")).add(literal(", ")).add(mark("max", "cast")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "integerRule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.IntegerRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "dateRule")), (condition("trigger", "rule"))).add(literal("new io.intino.tara.lang.model.rules.variable.DateRule(")).add(expression().add(mark("parameters", "quoted")).add(literal(","))).add(literal(")")),
