...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "rule & size")), (condition("trigger", "size"))).add(literal("new io.intino.tara.lang.model.rules.Size(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(")")),
