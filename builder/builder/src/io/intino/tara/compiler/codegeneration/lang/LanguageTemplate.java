...
public class LanguageTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "rule & size")), (condition("trigger", "size"))).add(literal("new Size(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(")")),
			...
			rule().add((condition("type", "rule & size")), (condition("trigger", "size"))).add(literal("new Size(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(expression().add(literal(", ")).add(mark("into", "size"))).add(literal(")")),
			rule().add((condition("type", "nativeObjectRule")), (condition("trigger", "rule"))).add(literal("new NativeObjectRule(\"")).add(mark("type")).add(literal("\")")),
			rule().add((condition("type", "nativeReferenceRule")), (condition("trigger", "rule"))).add(literal("new NativeReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "nativerule")), (condition("trigger", "rule"))).add(literal("new NativeRule(\"")).add(mark("interfaceClass")).add(literal("\", \"")).add(mark("signature")).add(literal("\", java.util.Arrays.asList(")).add(mark("imports", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "wordrule")), (condition("trigger", "rule"))).add(literal("new WordRule(java.util.Arrays.asList(")).add(mark("words", "quoted").multiple(", ")).add(literal(")")).add(expression().add(literal(", ")).add(mark("externalWordClass", "quoted"))).add(literal(")")),
			rule().add((condition("type", "referenceRule")), (condition("trigger", "rule"))).add(literal("new ReferenceRule(java.util.Arrays.asList(")).add(mark("allowedReferences", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "doubleRule")), (condition("trigger", "rule"))).add(literal("new DoubleRule(")).add(mark("min", "cast")).add(literal(", ")).add(mark("max", "cast")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "integerRule")), (condition("trigger", "rule"))).add(literal("new IntegerRule(")).add(mark("min")).add(literal(", ")).add(mark("max")).add(literal(", \"")).add(mark("metric")).add(literal("\")")),
			rule().add((condition("type", "dateRule")), (condition("trigger", "rule"))).add(literal("new DateRule(")).add(expression().add(mark("parameters", "quoted")).add(literal(","))).add(literal(")")),
			rule().add((condition("type", "instanceRule")), (condition("trigger", "rule"))).add(literal("new InstanceRule(")).add(expression().add(mark("parameters", "quoted")).add(literal(","))).add(literal(")")),
			rule().add((condition("type", "fileRule")), (condition("trigger", "rule"))).add(literal("new FileRule(java.util.Arrays.asList(")).add(mark("extensions", "quoted").multiple(", ")).add(literal("))")),
			rule().add((condition("type", "stringRule")), (condition("trigger", "rule"))).add(literal("new StringRule(")).add(mark("regex", "quoted")).add(literal(")")),
			...
			rule().add((condition("trigger", "primitive"))).add(literal("Primitive.")).add(mark("value", "UpperCase")),
