...
public class ListTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Node & owner")), not(condition("type", "inherited | overriden | instance")), (condition("trigger", "componentList"))).add(mark("name", "toCamelCase", "toCamelCase", "firstLowerCase")).add(literal("List.stream().forEach(c -> components.add(c.core$()));")),
