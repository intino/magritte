...
public class ConstructorTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "Variable & function")), (condition("type", "owner")), not(condition("type", "inherited | empty")), (condition("slot", "body")), (condition("trigger", "constructor"))).add(literal("_load(\"")).add(mark("name", "firstLowerCase")).add(literal("\", new java.util.ArrayList<>(java.util.Collections.singletonList(")).add(mark("workingPackage")).add(literal(".natives.")).add(mark("package")).add(literal(".")).add(mark("name", "javaValidName")).add(literal("_")).add(mark("uid")).add(literal(".class.getName())));")),
			...
			rule().add((condition("type", "Variable & resource")), (condition("type", "owner")), not(condition("type", "inherited | empty")), (condition("slot", "values")), (condition("trigger", "constructor"))).add(literal("_load(\"")).add(mark("name", "firstLowerCase")).add(literal("\", io.intino.tara.magritte.loaders.StringLoader.load(Arrays.asList(")).add(mark("values", "quoted").multiple(", ")).add(literal(")));")),
