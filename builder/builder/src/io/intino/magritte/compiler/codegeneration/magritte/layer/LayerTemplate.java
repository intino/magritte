...
import io.intino.magritte.compiler.codegeneration.magritte.layer.templates.layer.*;
...
public class LayerTemplate extends Template {
	...
	protected RuleSet ruleSet() {
		return new RuleSet()
				.add(getAll(new io.intino.magritte.compiler.codegeneration.magritte.layer.templates.layer.LayerTemplate().ruleSet()))
