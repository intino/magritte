...
public class InitTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(all(allTypes("variable", "word", "multiple", "outDefined", "owner"), not(any(any(allTypes("inherited"), allTypes("overriden")), allTypes("reactive")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.WordLoader.load(values, ")).output(placeholder("workingPackage", "LowerCase")).output(literal(".rules.")).output(placeholder("rule", "externalWordClass")).output(literal(".class, this);")));
		...
		rules.add(rule().condition(all(all(allTypes("variable", "word", "multiple", "owner"), not(any(any(allTypes("inherited"), allTypes("overriden")), allTypes("reactive")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.WordLoader.load(values, ")).output(placeholder("type")).output(literal(".class, this);")));
		rules.add(rule().condition(all(all(allTypes("variable", "word", "owner"), not(any(any(allTypes("inherited"), allTypes("overriden")), allTypes("reactive")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.WordLoader.load(values, ")).output(placeholder("type")).output(literal(".class, this).get(0);")));
		rules.add(rule().condition(all(all(allTypes("variable", "reactive", "owner"), not(any(allTypes("inherited"), allTypes("overriden")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.FunctionLoader.load(values, this, io.intino.magritte.framework.Expression.class).get(0);")));
		rules.add(rule().condition(all(all(allTypes("variable", "objectVariable", "owner", "multiple"), not(any(allTypes("inherited"), allTypes("overriden")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.ObjectLoader.load(values,")).output(placeholder("type", "withoutGeneric")).output(literal(".class, this);")));
		rules.add(rule().condition(all(all(allTypes("variable", "objectVariable", "owner"), not(any(allTypes("inherited"), allTypes("overriden")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.ObjectLoader.load(values,")).output(placeholder("type", "withoutGeneric")).output(literal(".class, this).get(0);")));
		rules.add(rule().condition(all(all(allTypes("variable", "function", "owner"), not(any(allTypes("inherited"), allTypes("overriden")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.FunctionLoader.load(values, this, ")).output(placeholder("workingPackage")).output(literal(".functions.")).output(placeholder("rule", "interfaceClass")).output(literal(".class).get(0);")));
		rules.add(rule().condition(all(all(allTypes("variable", "owner", "multiple"), not(any(allTypes("inherited"), allTypes("overriden")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.")).output(placeholder("type")).output(literal("Loader.load(values, this);")));
		rules.add(rule().condition(all(all(allTypes("variable", "owner"), not(any(any(any(allTypes("multiple"), allTypes("concept")), allTypes("inherited")), allTypes("overriden")))), trigger("init"))).output(literal("if (name.equalsIgnoreCase(\"")).output(placeholder("name", "FirstLowerCase")).output(literal("\")) this.")).output(placeholder("name", "toCamelCase", "javaValidName", "FirstLowerCase", "javaValidWord")).output(literal(" = io.intino.magritte.framework.loaders.")).output(placeholder("type")).output(literal("Loader.load(values, this).get(0);")));
		return rules;
	}
