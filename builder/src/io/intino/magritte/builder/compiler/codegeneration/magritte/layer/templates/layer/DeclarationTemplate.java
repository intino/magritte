...
public class DeclarationTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(all(allTypes("aspect"), not(allTypes("overriden"))), trigger("declaration"))).output(literal("protected ")).output(placeholder("qn", "reference")).output(literal(" _")).output(placeholder("name", "javaValidName", "FirstLowerCase")).output(literal(";")));
